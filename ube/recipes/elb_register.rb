# Recipe name: elb_register
#
# registers the instance to its ELB
#
...
if aws_access_key_token && aws_secret_key
  ...
  if is_jetty
    aws_elastic_lb "register jetty instance to ELB" do
  ...
  if is_node_js && !are_elbs_the_same
    aws_elastic_lb "register node.js instance to ELB" do
      aws_access_key aws_access_key_token
      aws_secret_access_key aws_secret_key
